...
import { Mail, Linkedin, Github, Target } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row gap-12">
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <a href="https://www.linkedin.com/in/kunal-rai-4312b5289/" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-cyber-textMain hover:text-cyber-fuchsia transition-colors cursor-pointer group">
            ...
            <a href="https://github.com/Kunalrai07" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-cyber-textMain hover:text-cyber-cyan transition-colors cursor-pointer group">
              <div className="p-4 bg-cyber-card border border-cyber-border rounded-xl group-hover:border-cyber-cyan/50 shadow-inner group-hover:shadow-[0_0_15px_rgba(0,229,255,0.3)] transition-all">
                <Github size={24} />
              </div>
              <span className="text-lg font-medium group-hover:text-glow-cyan">GitHub Profile</span>
            </a>
          </div>
        </motion.div>
